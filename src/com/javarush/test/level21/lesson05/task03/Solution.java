    ...
    public static void main(String[] args) throws InterruptedException
            {
                Date date = new Date();
                Date date2 = new Date();
                Solution instance = new Solution(1, "text", 3.5d, date, null);
                Solution sol1 = new Solution(1, "text", 3.5d, date, instance);
                Solution sol2 = new Solution(1, "text", 3.5d, date, instance);
