...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        {
            if (apt instanceof Apt1Room) ((Apt1Room) apt).clean1Room();
            else if (apt instanceof Apt2Room) ((Apt2Room) apt).clean2Rooms();
            else if (apt instanceof Apt3Room) ((Apt3Room) apt).clean3Rooms();
        }
    }
