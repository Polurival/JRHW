...
/*
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            int x = countStrings;
            java.lang.String[] s1 = reader.readLine().split("#");
            countStrings = Integer.parseInt(s1[1]) - 1;
            string1 = new String();
            java.lang.String[] s2 = reader.readLine().split("#");
            countStrings = Integer.parseInt(s2[1]) - 1;
            string2 = new String();
            countStrings = x;
